...
EGO_SUM=(
	...
	"github.com/aws/aws-sdk-go v1.42.19/go.mod"
	...
	"github.com/dave/dst v0.26.2/go.mod"
	"github.com/dave/gopackages v0.0.0-20170318123100-46e7023ec56e/go.mod"
	"github.com/dave/jennifer v1.2.0/go.mod"
	"github.com/dave/kerr v0.0.0-20170318121727-bc25dd6abe8e/go.mod"
	"github.com/dave/rebecca v0.9.1/go.mod"
	...
	"github.com/google/pprof v0.0.0-20181127221834-b4f47329b966/go.mod"
	...
	"github.com/hashicorp/aws-sdk-go-base v1.0.0/go.mod"
	...
	"github.com/serenize/snaker v0.0.0-20201027110005-a7ad2135616e/go.mod"
	...
	"github.com/terraform-linters/tflint-plugin-sdk v0.9.1/go.mod"
	"github.com/terraform-linters/tflint-ruleset-aws v0.10.1"
	"github.com/terraform-linters/tflint-ruleset-aws v0.10.1/go.mod"
	...
	"github.com/zclconf/go-cty v1.9.0/go.mod"
	...
	"golang.org/x/arch v0.0.0-20180920145803-b19384d3c130/go.mod"
...
SRC_URI="
	https://github.com/terraform-linters/tflint/archive/v${PV}.tar.gz -> ${P}.tar.gz
	${EGO_SUM_SRC_URI}
"
